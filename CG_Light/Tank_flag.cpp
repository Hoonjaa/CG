...
Tank_flag::Tank_flag()
{
	vColor = glm::vec3(0.7f, 0.0f, 0.0f);
	setVertexInfo();
...
GLvoid Tank_flag::draw(const GLuint& ShaderID, const glm::mat4& worldMatrix, const glm::mat4& viewProjMatrix)
{
