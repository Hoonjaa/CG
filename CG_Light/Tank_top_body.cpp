...
Tank_top_body::Tank_top_body()
{
	vColor = glm::vec3(0.0f, 0.7f, 0.1f);
	setVertexInfo();
...
GLvoid Tank_top_body::draw(const GLuint& ShaderID, const glm::mat4& worldMatrix, const glm::mat4& viewProjMatrix)
{
