...
private:
	...
	std::shared_ptr<Object_Part> lowBodyPart;
	std::shared_ptr<Object_Part> middleBodyPart;
	std::shared_ptr<Object_Part> topBody1Part;
	std::shared_ptr<Object_Part> topBody2Part;
	std::shared_ptr<Object_Part> cannon1Part;
	std::shared_ptr<Object_Part> cannon2Part;
	std::shared_ptr<Object_Part> flag1Part;
	std::shared_ptr<Object_Part> flag2Part;
...
public:
	GLvoid setup(GLuint shader) {
		...
		lowBodyPart = std::make_shared<Object_Part>(lowBodyObj, shader);
		root->addChild(lowBodyPart);

		// 중간 몸체 생성
		auto middleBodyObj = std::make_shared<Tank_middle_body>();
		middleBodyPart = std::make_shared<Object_Part>(middleBodyObj, shader);
		...
		topBody1Part = std::make_shared<Object_Part>(topBodyObj, shader);
		...
		topBody2Part = std::make_shared<Object_Part>(topBodyObj2, shader);
